...
payload =   json.dumps({"filter":[{"left":"exchange","operation":"equal","right":"BYBIT"},{"left":"Perf.W","operation":"less","right":0},{"left":"Perf.1M","operation":"egreater","right":0},{"left":"Perf.3M","operation":"egreater","right":0},{"left":"Perf.6M","operation":"egreater","right":0},{"left":"Perf.Y","operation":"greater","right":0},{"left":"Perf.YTD","operation":"egreater","right":0},{"left":"Perf.5Y","operation":"egreater","right":0},{"left":"Perf.All","operation":"egreater","right":0},{"left":"currency","operation":"equal","right":"USDT"}],"options":{"lang":"en"},"filter2":{"operator":"and","operands":[{"operation":{"operator":"or","operands":[{"expression":{"left":"type","operation":"in_range","right":["spot"]}}]}}]},"markets":["crypto"],"symbols":{"query":{"types":[]},"tickers":[]},"columns":[],"range":[0,150]})
